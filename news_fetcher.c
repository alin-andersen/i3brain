...
#define ARTICLES_MAX 25
#define SOURCES_MAX  25
...
{
    // get last source and rotate
    struct news_source* source = fetch->last;

    // get last article and rotate
    struct news_article* article = source->last;
